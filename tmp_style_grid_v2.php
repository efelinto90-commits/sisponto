...
// 1. Identify accurately the old Section 4 block
$startMarker = '<!-- SeÃ§Ã£o 4: Quadro de HorÃ¡rios Semanal -->';
$endMarker = '<!-- SeÃ§Ã£o 5: Dados BancÃ¡rios -->';
...
if ($startPos !== false && $endPos !== false) {
                            ...
                            <div class="flex items-center justify-between gap-3 border-b border-slate-100 pb-3 mb-4">
                                <div class="flex items-center gap-3">
                                    <div class="w-8 h-8 rounded-lg bg-indigo-50 flex items-center justify-center text-indigo-600 font-bold">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                                    </div>
    ...
    echo "E-Social styling successfully applied to relogio.php modal.\n";
} else {
    echo "Markers NOT found. startPos: " . ($startPos !== false ? "OK" : "MISSING") . ", endPos: " . ($endPos !== false ? "OK" : "MISSING") . "\n";
}
?>
